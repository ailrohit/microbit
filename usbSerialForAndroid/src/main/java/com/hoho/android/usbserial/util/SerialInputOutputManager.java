...
public class SerialInputOutputManager implements Runnable {
    ...
    public void writeAsync(byte[] data) {
        Log.i(TAG, "writeAsync. with state " + getState());
        ...
        try {
            ...
            e.printStackTrace();
            Log.i(TAG, "handleOutgoingData error " + e.getMessage());
        }
    }
    ...
    private void step() throws IOException {
        ...
        if (DEBUG) Log.d(TAG, "looping and stepping at " + System.currentTimeMillis());
    ...
    private void handleOutgoingData() throws IOException{
        int len = 0;
        byte[] outBuff = null;
        synchronized (mWriteBuffer) {
